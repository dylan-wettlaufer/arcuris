...
def process_resume(
    ...
    draft_json = merge_with_inventory(
        parsed, draft.resumeJson, draft.bulletRewrites
    )
    ...
    final_json = merge_with_inventory(
        parsed, refined.resumeJson, refined.bulletFeedback
    )
