...
def merge_generated_resume(
    ...
    *,
    draft_resume_markdown: str | None = None,
    refined_resume_markdown: str | None = None,
    resume_json: GeneratedResumeJson | None = None,
) -> dict[str, Any]:
    merged = GeneratedResume(
        companyName=draft.companyName,
        roleTitle=draft.roleTitle,
        draftResumeMarkdown=draft_resume_markdown or draft.resumeMarkdown,
        refinedResumeMarkdown=refined_resume_markdown or refined.resumeMarkdown,
        resumeJson=resume_json or refined.resumeJson,
